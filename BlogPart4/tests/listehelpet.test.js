...
describe("max blogs", () => {
  ...
  test("Author with max number of blogs", () => {
    const result = listHelper.maxBlogs(listWithOneBlog, "author");
...
describe("Author with the best blog", () => {
  ...
  test("author, whose blog posts have the largest amount of likes", () => {
    ...
    expect(result).toEqual({
      author: listWithOneBlog[3].author,
      likes: listWithOneBlog[3].likes,
    });
  });
});
